#ifndef ScapegoatST1_H
#define ScapegoatST1_H
...
template <typename T>
int ScapegoatST1<T>::getSize(){
  return m_size;
}

template <typename T>
void ScapegoatST1<T>::insert(T d){
...
template <typename T>
void ScapegoatST1<T>::insertHelper(TreeNode<T>*& subTreeRoot, TreeNode<T>* newNode){
  if(subTreeRoot == NULL){
    subTreeRoot = newNode;
...
template <typename T>
bool ScapegoatST1<T>::contains(T d){
  TreeNode<T>* newNode = new TreeNode<T>(d);
...
template <typename T>
bool ScapegoatST1<T>::containsHelper(TreeNode<T>* subTreeRoot, TreeNode<T>* newNode){
  if(subTreeRoot == NULL){
    return false;
  } else if(newNode->m_data == subTreeRoot->m_data){
    return true;
...
template <typename T>
void ScapegoatST1<T>::printTreeInOrder(){
  printTreeInOrderHelper(m_root);
}

template <typename T>
void ScapegoatST1<T>::printTreeInOrderHelper(TreeNode<T>* subTreeRoot){
  if(subTreeRoot != NULL){
...
template <typename T>
void ScapegoatST1<T>::printTreePostOrder(){
  printTreePostOrderHelper(m_root);
}

template <typename T>
void ScapegoatST1<T>::printTreePostOrderHelper(TreeNode<T>* subTreeRoot){
  if(subTreeRoot != NULL){
    printTreeInOrderHelper(subTreeRoot->m_left);
    printTreeInOrderHelper(subTreeRoot->m_right);
    cout << subTreeRoot->m_data << endl;
...
/*
template <typename T>
bool ScapegoatST1::iterativeContains(T d){
  if(m_root == NULL){
    return false;
  }
  if(m_root->m_data ==  d){
...
template <typename T>
T ScapegoatST1<T>::getMin(){
  //check if empty
  return getMinHelper(m_root);
}

template <typename T>
T ScapegoatST1<T>::getMinHelper(TreeNode<T>* subTreeRoot){
...
template <typename T>
T ScapegoatST1<T>::getMax(){
  //check if empty
  return getMaxHelper(m_root);
}

template <typename T>
T ScapegoatST1<T>::getMaxHelper(TreeNode<T>* subTreeRoot){
...
template <typename T>
T ScapegoatST1<T>::getMedian(){
  //check if empty
  return m_root->m_data;
}

template <typename T>
void ScapegoatST1<T>::findTarget(T key, TreeNode<T>*& target, TreeNode<T>*& parent){
...
template <typename T>
TreeNode<T>* ScapegoatST1<T>::getSuccessor(TreeNode<T>* rightChild){
...
template <typename T>
void ScapegoatST1<T>::remove(T d){
  //check if empty
